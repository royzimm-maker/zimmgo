    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto max-w-2xl px-4 py-10 sm:px-6">
        ...
        <div className="flex flex-col gap-6 text-sm text-slate-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-sm font-semibold text-slate-900 mb-1.5">AI can make mistakes</h2>
            <p>
              Everything ZimmGo suggests — itineraries, hotel and restaurant picks, visa and seasonal notes, ZiGy&apos;s chat answers — is generated by Claude, an AI model. It&apos;s usually good, but AI can get things wrong: a detail can be outdated, a recommendation can be off, a fact can simply be incorrect. Treat ZimmGo as a starting point, not a source of truth, and double-check anything that actually matters before you rely on it — visa requirements, opening hours, prices, and anything else that could cost you time or money if it&apos;s wrong.
            </p>
          </section>
