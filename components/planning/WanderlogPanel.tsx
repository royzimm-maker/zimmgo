    ...
    <div className="flex h-full flex-col">
      <div className="shrink-0 border-b border-slate-200 px-4 py-2.5">
        <div className="flex items-center gap-2">
          <BookMarked size={13} className="text-brand-500 shrink-0" />
        ...
        <p className="mt-1 text-[10px] text-slate-400 leading-snug">
          Your save-for-later list — click <BookMarked size={9} className="inline -mt-0.5" /> on any suggestion to bookmark it here for when you're actually travelling.
        </p>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-3 py-2.5 space-y-3">
        {groups.length === 0 && (
          <p className="text-[11px] text-slate-400 text-center py-4">
            Nothing saved yet — tap the bookmark on any pick to add it here.
          </p>
        )}
